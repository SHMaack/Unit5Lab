...
public class ThrowsException {
    ...
    public void throwAnExceptionForMe() throws BadStringOperationException, 
    InterruptedException, MyException 
    {
    	...
    	{
    		MyException ex = new MyException(e.getMessage(), e);
    		throw ex;
    	}
    ...
    private void thowMultipleExceptionsForMe() throws BadStringOperationException, 
